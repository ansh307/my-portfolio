...
/**
 * Primary content in *AllTechsYouKnow → Items*
 */
export interface AllTechsYouKnowSliceDefaultItem {
  /**
   * Techs you know field in *AllTechsYouKnow → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: all_techs_you_know.items[].techs_you_know
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  techs_you_know: prismic.KeyTextField;
}

/**
 * Default variation for AllTechsYouKnow Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type AllTechsYouKnowSliceDefault = prismic.SharedSliceVariation<
  "default",
  Record<string, never>,
  Simplify<AllTechsYouKnowSliceDefaultItem>
>;

/**
 * Slice variation for *AllTechsYouKnow*
 */
type AllTechsYouKnowSliceVariation = AllTechsYouKnowSliceDefault;

/**
 * AllTechsYouKnow Shared Slice
 *
 * - **API ID**: `all_techs_you_know`
 * - **Description**: AllTechsYouKnow
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type AllTechsYouKnowSlice = prismic.SharedSlice<
  "all_techs_you_know",
  AllTechsYouKnowSliceVariation
>;
...
/**
 * TextBlock variation for TextBlog Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      AllTechsYouKnowSlice,
      AllTechsYouKnowSliceDefaultItem,
      AllTechsYouKnowSliceVariation,
      AllTechsYouKnowSliceDefault,
      BiographySlice,
